...
import com.itis.devinterview.databinding.FragmentPythonBinding

class PythonFragment: Fragment(R.layout.fragment_python) {

    private var _binding: FragmentPythonBinding? = null
    private val binding get() = _binding!!
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        _binding = FragmentPythonBinding.bind(view)
        with(binding) {
